...
* [GitHub Repo](https://github.com/MithrilJS/mithril.js) ⭐ 14,499 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13
* [Job listing](https://github.com/MithrilJS/mithril.js/wiki/JOBS) ⭐ 14,499 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13
* [Who uses Mithril?](https://github.com/MithrilJS/mithril.js/wiki/Who-Uses-Mithril) ⭐ 14,499 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13
...
* [Zulip Chat Room](https://mithril.zulipchat.com)
...
* [Tutanota](https://github.com/tutao/tutanota) ⭐ 7,914 | 🐛 998 | 🌐 TypeScript | 📅 2026-09-11 - Secure emails for everybody.
* [Flems](https://github.com/porsager/flems) ⭐ 539 | 🐛 28 | 🌐 JavaScript | 📅 2023-11-03 - Web playground & sandbox as an embeddable module.
* [Treehouse](https://github.com/treehousedev/treehouse) ⭐ 189 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-31 - Lightweight outliner app built with Deno and Mithril. Use in the browser or build your own custom app.
...
* [Freddy](https://github.com/spacejack/freddy) ⭐ 19 | 🐛 2 | 🌐 TypeScript | 📅 2018-05-23 - Mobile Reddit Reader.
* [Vegan](https://github.com/mrdaak/vegan) ⚠️ Archived - Minimalistic "Kanban boardish" client.
* [WaveShader](https://github.com/spacejack/waveshader) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2019-03-03 - Audio wave sketchpad.
* [Mithril tutorial app](https://github.com/spacejack/mithril-tutorial-ts) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2018-08-16 - The tutorial app from mithril.js.org adapted to Typescript.
* [gomithrilapp](https://github.com/josephspurrier/gomithrilapp) ⭐ 10 | 🐛 37 | 🌐 Go | 📅 2023-01-07 - Sample notepad application in Mithril (JSX) and Go showing good practices and integrations with modern tools using Bulma, Cypress, Docker, ESLint, gvt, make, Rove, Swagger, and Travis-CI.
* [gomithriltsapp](https://github.com/josephspurrier/gomithriltsapp) ⭐ 6 | 🐛 22 | 🌐 Go | 📅 2023-01-07 - Sample notepad application in Mithril (TypeScript and HyperScript) and Go showing good practices and integrations with modern tools using Bulma, Cypress, Docker, ESLint, gvt, make, Mock Service Worker, Rove, Swagger, and Travis-CI.
* [Flash Games Catalog](https://gitlab.com/beelzy/fg-catalog) - Catalog and launcher for flash games.

#### Snippets

* [Infinite Scroll for Mithril on mobile and desktop](https://github.com/ArthurClemens/mithril-infinite) ⚠️ Archived
* [Modal component example](https://github.com/spacejack/mithril-modal) ⭐ 16 | 🐛 0 | 🌐 JavaScript | 📅 2019-03-07
* [Simple carousel](https://github.com/spacejack/m-carousel) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2017-04-16
...
* [Nested hyperscript helper](https://flems.io/#0=-BYEwMNFiSRcbF+0Su+Qmcx6bWZYgAYXo2ROqLHUk4+AhaGajYAKgBZAAyTkBMBKXjwAEYACyIADMAHYQmEQJgcHhU-MnAl1x-NMM2zXNA3JMA10zMBsGgABPCNgOoZ4wKwOAAG5ew9NAi3A4M6FbHQIzFTC3QvVwrw8G8fACRBbxCABdKg1jQABrbxUE-CI8HTKpenIKgBXIHwSGIUQ4EQVIilEViblTWgsBUXjCH4gABAAmfAAAZ8HvJTKhU6BBwhGI4hAYg4KaPA4GoXpRGSYIGOCIA)
* [Using Powerform + Mithril](https://codesandbox.io/s/powerform-mithril-pdrl1?file=/src/index.js)

#### Starter kits

* [mithril-starter-kit](https://github.com/dhinesh03/mithril-starter-kit) ⚠️ Archived - A boilerplate Mithril application using Webpack 4, ES6, Sass/SCSS, Js and scss hot reload and eslint
* [sourcestack](https://github.com/stackplanet/sourcestack) ⭐ 48 | 🐛 23 | 🌐 TypeScript | 📅 2023-01-11 - Template for full-stack Typescript web apps on AWS, using Mithril on the front end.
* [Game development with Mithril/THREE.js/Typescript](https://github.com/spacejack/three-mithril-ts) ⭐ 40 | 🐛 14 | 🌐 TypeScript | 📅 2022-12-10
* [Mithril Starter Project with Rollup, Babel, LiveReload, Jest and ESLint](https://github.com/ArthurClemens/mithril-starter-rollup) ⚠️ Archived
* [Mithril/Typescript/PostCSS/Browserify/HMR/Budō](https://github.com/spacejack/mithril-browserify-ts-budo) ⭐ 19 | 🐛 14 | 🌐 TypeScript | 📅 2022-12-10
* [Mithril/Typescript/SASS/PostCSS/Webpack2](https://github.com/spacejack/mithril-webpack-ts) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2017-05-07
...
* [Ospec](https://github.com/MithrilJS/mithril.js/tree/rewrite/ospec) ⭐ 14,499 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13 - Mithril's own fast test runner.
* [Mithril Query](https://github.com/MithrilJS/mithril-query) ⭐ 106 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-13 - Query Mithril virtual dom for testing purposes.

### Libraries, Components & Plugins

* [Polythene](https://github.com/ArthurClemens/Polythene) ⚠️ Archived - Material Design for Mithril and React.
* [mopt](https://github.com/MithrilJS/mopt) ⚠️ Archived - Optimize `m()` calls to javascript objects.
* [mithril-helpers](https://github.com/isiahmeadows/mithril-helpers) ⭐ 32 | 🐛 1 | 🌐 JavaScript | 📅 2021-04-23 - Collection of Mithril helpers and utilities.
* [Mithril-Datepicker](https://github.com/CreaturesInUnitards/mithril-datepicker) ⭐ 25 | 🐛 5 | 🌐 JavaScript | 📅 2018-10-16 - Localizable date picker.
* [mithril-portal](https://github.com/vrimar/mithril-portal) ⭐ 16 | 🐛 2 | 🌐 TypeScript | 📅 2024-02-04 - a component for rendering inline children to `document.body`
* [mithril-graphql](https://github.com/benthepoet/mithril-graphql) ⭐ 12 | 🐛 0 | 🌐 CoffeeScript | 📅 2021-07-24 - A lightweight GraphQL client for the Mithril framework.
* [mithril-transition-group](https://github.com/vrimar/mithril-transition-group) ⭐ 10 | 🐛 1 | 🌐 TypeScript | 📅 2023-03-04 - Components for creating state/class based transitions.
* [famicon](https://github.com/kliksob/famicon) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2021-08-10 - Fontawesome svg icons component for mithril
...
* [Github Wiki](https://github.com/MithrilJS/mithril.js/wiki) ⭐ 14,499 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13 - Wiki content is mostly about the 0.2 version, some material may be more up to date with the current API.
